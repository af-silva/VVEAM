<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_AARHemorragia, App_Web_0h3rwstd" %>
...
<div class="backoffice-body">
        <asp:Label runat="server" ID="lttTitle" Text="Novo Risco de Hemorragia" Font-Size="Large"></asp:Label>
    </div>
    <div id="error">
