<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_GInstituicoes, App_Web_0h3rwstd" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageMainContent" runat="Server">
    <div style="padding: 10px 20px 10px 0px;">
        <asp:Label runat="server" ID="lgtTitle" Text="Gerir Instituições" Font-Size="Large"></asp:Label>
            ...
            <ContentTemplate>
                <asp:GridView runat="server" ID="gvGrid" AutoGenerateColumns="False" DataKeyNames="CODIGO"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NUMERO_CONTACTO" HeaderText="Contacto" ReadOnly="True"
                            SortExpression="NUMERO_CONTACTO" />
                ...
                <asp:LinqDataSource ID="ldsGridView" runat="server" ContextTypeName="DAL.VVEAM_Entity"
                    EntityTypeName="" Select="new (CODIGO,SIGLA, NOME, OCR_CODU, NUMERO_CONTACTO, ESTADO)"
                    TableName="GI_INSTITUICAO" OrderBy="CODIGO">
                </asp:LinqDataSource>
