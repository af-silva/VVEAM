<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_GTripulantes, App_Web_0h3rwstd" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageMainContent" runat="Server">
    <div style="padding: 10px 20px 10px 0px;">
        <asp:Label runat="server" ID="lgtTitle" Text="Gerir Tripulantes" Font-Size="Large"></asp:Label>
        ...
        <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="NUMERO_PESSOAL" HeaderText="Numero Pessoal" ReadOnly="True"
                    SortExpression="NUMERO_PESSOAL" />
                <asp:BoundField DataField="NOME" HeaderText="Nome" ReadOnly="True" SortExpression="NOME" />
                <asp:TemplateField HeaderText="Tipo Tripulante" SortExpression="OCR_TIPO_TRIPULANTE.NOME"
                    ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <%# Eval("OCR_TIPO_TRIPULANTE.NOME") %>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:LinqDataSource ID="ldsGridView" runat="server" ContextTypeName="DAL.VVEAM_Entity"
            EntityTypeName="" Select="new (CODIGO, OCR_TIPO_TRIPULANTE, OCR_CODU, NUMERO_PESSOAL, NOME, ESTADO)"
            TableName="OCR_TRIPULANTE" OrderBy="CODIGO">
        </asp:LinqDataSource>
    </ContentTemplate>
            <Triggers>
