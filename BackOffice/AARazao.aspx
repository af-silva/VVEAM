<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_AARazao, App_Web_0h3rwstd" %>
...
<div class="backoffice-body">
        <asp:Label runat="server" ID="lttTitle" Text="Nova Razão" Font-Size="Large"></asp:Label>
    </div>
    <div id="error">
