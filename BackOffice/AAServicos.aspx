<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_AAServicos, App_Web_0h3rwstd" enableeventvalidation="true" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageMainContent" runat="Server">
    <div class="backoffice-body">
        <asp:Label runat="server" ID="lauTitle" Text="Novo Serviço" Font-Size="Large"></asp:Label>
    </div>
    <div id="error">
