<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_GerirTipoTripulante, App_Web_0h3rwstd" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageMainContent" runat="Server">
    <div style="padding: 10px 20px 10px 0px;">
        <asp:Label runat="server" ID="lauTitle" Text="Gerir Tipo de Tripulante" Font-Size="Large"></asp:Label>
                ...
                <div style="float: right">
                    <ul class="opmenu topmenu">
                        ...
                        <li>
                            ...
                            <asp:LinkButton ID="ButtonRemover" runat="server" Text="Editar" OnClick="ButtonEditar_Click"
        ...
        <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
            <ContentTemplate>
                ...
                <asp:LinqDataSource ID="ldsGridView" runat="server" ContextTypeName="DAL.VVEAM_Entity"
                    EntityTypeName="" Select="new (CODIGO, NOME, ESTADO)" TableName="OCR_TIPO_TRIPULANTE"
                    OrderBy="CODIGO">
                </asp:LinqDataSource>
            </ContentTemplate>
            <Triggers>
