<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_AALocalContacto, App_Web_0h3rwstd" %>
...
<div class="backoffice-body">
        <asp:Label runat="server" ID="lttTitle" Text="Novo Local de Contacto" Font-Size="Large"></asp:Label>
    </div>
    <div id="error">
