<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_GCodu, App_Web_0h3rwstd" %>
...
<div style="padding: 10px 20px 10px 0px;">
        <asp:Label runat="server" ID="lgtTitle" Text="Gerir Centros de Doentes Urgentes (CODU)" Font-Size="Large"></asp:Label>
        ...
        <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
            ...
            <asp:LinqDataSource ID="ldsGridView" runat="server" ContextTypeName="DAL.VVEAM_Entity"
                EntityTypeName="" Select="new (CODIGO, NOME, ESTADO)" TableName="OCR_CODU"
                OrderBy="CODIGO" >
            </asp:LinqDataSource>
        </ContentTemplate>
            <Triggers>
