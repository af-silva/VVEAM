<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_GUtilizador, App_Web_0h3rwstd" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageMainContent" runat="Server">
    ...
    <div style="padding: 10px 20px 10px 0px;">
        ...
        <asp:Label runat="server" ID="lgtTitle" Text="Gerir Utilizadores" Font-Size="Large"></asp:Label>
        ...
        <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
            <ContentTemplate>
              ...
              <asp:GridView runat="server" ID="gvGrid" AutoGenerateColumns="false" 
                        CellPadding="8" GridLines="None" CssClass="Grid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                        PageSize="10" DataSourceID="ldsGridView" 
                        OnSelectedIndexChanged="gvGrid_SelectedIndexChanged"  OnRowDataBound="gvGrid_RowDataBound">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Nome de Utilizador" ItemStyle-VerticalAlign="Middle" SortExpression="UserName">
                    <ItemTemplate>
                        <asp:Label ID="lUserName" runat="server" Text='<%# Convert.ToString(Eval("UserName")) %>' />
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Instituição" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:Label ID="lInstituicao" runat="server" />
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:BoundField DataField="LastloginDate" HeaderText="Ultimo Login" ReadOnly="True" SortExpression="LastloginDate" />

                <asp:TemplateField HeaderText="Estado" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:Label ID="lEstado" runat="server" Text='<%#  Convert.ToString(Eval("IsApproved")) == "True" ? "Activo" : "Inactivo" %>' />
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:LinqDataSource ID="ldsGridView" runat="server"
            EntityTypeName="" OnSelecting ="ldsSintomas_Selecting">
        </asp:LinqDataSource>
