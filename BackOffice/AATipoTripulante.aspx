<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_AATipoTripulante, App_Web_0h3rwstd" enableeventvalidation="true" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageMainContent" runat="Server">
    <div class="backoffice-body">
        <asp:Label runat="server" ID="lttTitle" Text="Novo Tipo de Tripulante" Font-Size="Large"></asp:Label>
    </div>
    <div id="error">
    ...
    <div class="backoffice-body">
        ...
        <%--<asp:RegularExpressionValidator ID="revTipoTripulante" runat="server" ValidationExpression="[\u00C0-\u017E]"
            ControlToValidate="tbNome" ValidationGroup="vgError"
            ErrorMessage="O campo Tipo de Tripulante só permite letras." Display="none">
        </asp:RegularExpressionValidator>--%>
        <asp:RequiredFieldValidator ID="rfvTipoTripulante" runat="server" ControlToValidate="tbNome"
