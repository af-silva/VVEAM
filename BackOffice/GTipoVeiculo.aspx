<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_GTipoVeiculo, App_Web_0h3rwstd" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageMainContent" runat="Server">
    <div style="padding: 10px 20px 10px 0px;">
        ...
        <asp:LinqDataSource ID="ldsGridView" runat="server" ContextTypeName="DAL.VVEAM_Entity"
            EntityTypeName="" Select="new (CODIGO, SIGLA, NOME, ESTADO)" TableName="OCR_TIPO_VEICULO"
            OrderBy="CODIGO">
        </asp:LinqDataSource>
    </ContentTemplate>
            <Triggers>
