<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_GVeiculos, App_Web_0h3rwstd" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageMainContent" Runat="Server">
    ...
    <div style="padding: 10px 20px 10px 0px;">
        <asp:Label runat="server" ID="lgtTitle" Text="Gerir Tipo de Veiculo" Font-Size="Large"></asp:Label>
        ...
        <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Tipo de Veiculo" SortExpression="OCR_TIPO_VEICULO.SIGLA" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <%# Eval("OCR_TIPO_VEICULO.SIGLA")%>
                    </ItemTemplate>
        ...
        <asp:LinqDataSource ID="ldsGridView" runat="server" ContextTypeName="DAL.VVEAM_Entity"
            EntityTypeName="" Select="new (CODIGO, OCR_TIPO_VEICULO, OCR_CODU, NOME, ESTADO)" TableName="OCR_VEICULO"
            OrderBy="CODIGO" >
        </asp:LinqDataSource>
