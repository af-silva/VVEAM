<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_AACodu, App_Web_0h3rwstd" enableeventvalidation="true" %>
...
<div class="backoffice-body">
        <asp:Label runat="server" ID="lttTitle" Text="Novo Centro de Orientação de Doentes Urgentes (CODU)" Font-Size="Large"></asp:Label>
    </div>
    <div id="error">
