<%@ page title="" language="C#" masterpagefile="~/Layouts/LeftMenuLayout.master" autoeventwireup="true" inherits="BackOffice_GServicos, App_Web_0h3rwstd" %>
...
<div style="padding: 10px 20px 10px 0px;">
        ...
        <asp:LinqDataSource ID="ldsGridView" runat="server" ContextTypeName="DAL.VVEAM_Entity"
            EntityTypeName="" Select="new (CODIGO, SIGLA, NOME, ESTADO)" TableName="GI_SERVICO"
            OrderBy="CODIGO" >
        </asp:LinqDataSource>
    </ContentTemplate>
            <Triggers>
